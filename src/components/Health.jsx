...
export default function Health() {
    ...
    const fetchData = async () => {
        let response = await fetch("https://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=6ed3f24f506f410c896c667f925a8ff1");
