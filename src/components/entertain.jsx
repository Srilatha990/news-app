...
export default function Entertainment() {
    ...
    const fetchData = async () => {
        let response = await fetch("https://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=6ed3f24f506f410c896c667f925a8ff1");
  ...
  return (
    <div style={{marginLeft:'300px'}}>
         <h1>Search : Entertainment News</h1>
