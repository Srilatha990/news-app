...
export default function Science() {
    ...
    const fetchData = async () => {
        let response = await fetch("https://newsapi.org/v2/top-headlines?country=in&category=science&apiKey=6ed3f24f506f410c896c667f925a8ff1");
